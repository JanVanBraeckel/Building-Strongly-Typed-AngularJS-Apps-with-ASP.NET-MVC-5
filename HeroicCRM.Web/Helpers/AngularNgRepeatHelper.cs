...
namespace HeroicCRM.Web.Helpers
{
    ...
    {
        public AngularNgRepeatHelper(HtmlHelper helper, string variableName, string propertyExpression):base(helper, variableName)
        {
            var div = new HtmlTag("div");
            div.Attr("ng-repeat", $"{variableName} in {propertyExpression}");
            div.NoClosingTag();
